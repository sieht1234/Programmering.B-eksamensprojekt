...
//vi opretter en variable APP som inderholder server biblioteket
const app = express()
//vælg en port
const port = 4444
...
//serverens måde at håndtere (variabler) hvor henne i spillet vi er
...
serverSocket.on('connection', socket => {
    ...
    if(players.length >= 2){
        ...
        //smid spilleren ud, luk hans socket
        socket.disconnect()
    }else{
